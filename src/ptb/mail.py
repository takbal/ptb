...
def send_email(credentials: str, token: str, sender: str, to: str, subject: str, message_text: str,
    ...
    message = create_message_with_attachments( sender, to, subject, message_text, attachments )
